...
$page=$_GET["page"];
if ($page){
echo msglayerurl("删除成功",8,"zuan.php?page=$page");
}else{
echo msglayerurl("删除成功",8,"zuan.php");
}
}
?>
<!DOCTYPE html>
...
<input type="button" class="button" value="资源添加" onClick="location.href='zuantj.php'">
</p></form>
