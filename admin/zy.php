...
$page=$_GET["page"];
if ($page){
echo msglayerurl("删除成功",8,"zy.php?page=$page");
}else{
echo msglayerurl("删除成功",8,"zy.php");
}
}
?>
<!DOCTYPE html>
...
<input type="button" class="button" value="资源添加" onClick="location.href='zytj.php'">
</p></form>
...
$result = mysql_query("select id from ubosk ".$sql."  ");
...
$query = mysql_query("select * from  ubosk   ".$sql." order by id desc   limit $offset, $Page_size");
