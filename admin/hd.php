...
$page=$_GET["page"];
if ($page){
echo msglayerurl("删除成功",8,"hd.php?page=$page");
}else{
echo msglayerurl("删除成功",8,"hd.php");
}
}
?>
<!DOCTYPE html>
...
<input type="button" class="button" value="资源添加" onClick="location.href='hdtj.php'">
</p></form>
...
$result = mysql_query("select id from ubohd ".$sql."  ");
...
$query = mysql_query("select * from  ubohd   ".$sql." order by id desc   limit $offset, $Page_size");
