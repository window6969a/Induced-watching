...
if($del=="del"){
$type="id='$delid'";
dbdel(ubozhainan,$type);
$page=$_GET["page"];
if ($page){
echo msglayerurl("删除成功",8,"zn.php?page=$page");
}else{
echo msglayerurl("删除成功",8,"zn.php");
}
}
?>
<!DOCTYPE html>
...
<input type="button" class="button" value="资源添加" onClick="location.href='zntj.php'">
</p></form>
...
$result = mysql_query("select id from ubozhainan ".$sql."  ");
...
$query = mysql_query("select * from  ubozhainan   ".$sql." order by id desc   limit $offset, $Page_size");
